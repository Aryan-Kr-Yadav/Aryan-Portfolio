...
import { n as getClassName } from "./index-CLOTiFb2-TK0tIh5p.js";
...
function useFloatingPortalNode(props) {
	...
	const portalNodeRef = import_react.useRef(null);
	index$1(() => {
		return () => {
			portalNode?.remove();
			queueMicrotask(() => {
...
function useDelayUnmount(open, durationMs) {
	const [isMounted, setIsMounted] = import_react.useState(open);
...
function useTransitionStatus(context, props) {
	...
	const [status, setStatus] = import_react.useState("unmounted");
...
function useTransitionStyles(context, props) {
	...
	const fnArgs = import_react.useMemo(() => ({
		side,
		placement
	}), [side, placement]);
	...
	const [styles, setStyles] = import_react.useState(() => ({
	...
	index$1(() => {
		...
		if (status === "initial") setStyles((styles) => ({
...
//#endregion
//#region node_modules/react-activity-calendar/build/chunks/Tooltip-B8gZJWmn.js
function Tooltip({ children, text, colorScheme, placement, offset: offsetProp = 4, transitionStyles: transitionStylesProp, hoverRestMs = 150, withArrow = false }) {
	...
	const { getReferenceProps, getFloatingProps } = useInteractions([
		useHover(context, { restMs: hoverRestMs }),
		useDismiss(context),
		useRole(context, { role: "tooltip" })
	]);
	const { isMounted, styles: transitionStyles } = useTransitionStyles(context, transitionStylesProp);
	return /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/*#__PURE__*/ (0, import_react.cloneElement)(children, {
		ref: refs.setReference,
		...getReferenceProps()
	}), isMounted && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FloatingPortal, { children: /*#__PURE__*/ (0, import_jsx_runtime.jsxs)("div", {
		...
		...getFloatingProps(),
		children: [text, withArrow && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FloatingArrow, {
			ref: arrowRef,
			context,
